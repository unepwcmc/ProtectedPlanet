    ...
    module Importers
      class GeometryImporter
        def self.import
          ...
          results[:protected_areas] = import_geometry_for_table(
          ...
          results[:protected_area_parcels] = import_geometry_for_table(
            Wdpa::Portal::Config::StagingConfig.get_staging_table_name_from_live_table('protected_area_parcels')
          )
