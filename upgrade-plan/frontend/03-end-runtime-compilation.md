...
| 6 | `thematic-database.ts` | `_tabs-thematic-area-database.html.erb` → `ThematicDatabasePage.vue` ([14](./14-architecture-and-design.md#cms--frontend-integration)) |
| 7 | `equity-tabs.ts` | `_tabs-equity.html.erb` |
| 8+ | Per stats/chart partial | Country, region, marine, target dashboard, … |
