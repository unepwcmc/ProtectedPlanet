      ...
      class AttributeImporter
        ...
        def self.process_batch(batch, wdpaids_multiple_parcels_map)
          ...
          batch.each do |pa_attributes|
            ...
            # Create ProtectedArea record (only for first/only parcel)
            ...
            # Create ProtectedAreaParcel record (for all parcels when multiple exist)
        ...
        def self.protected_area_ids_with_multiple_parcels
          ...
          # Check only portal views that contain protected area data (polygons and points)
          # Sources view is excluded as it doesn't contain protected area parcel data
        ...
        private_class_method :current_entry_parcel_info, :protected_area_ids_with_multiple_parcels
      end
    end
  end
end
