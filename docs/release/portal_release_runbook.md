...
RAILS_ENV=production PP_RELEASE_DRY_RUN=true bundle exec rake pp:portal:release["Sep2026"]
...
RAILS_ENV=production PP_RELEASE_START_AT=finalise_swap bundle exec rake pp:portal:release["Sep2026"]
