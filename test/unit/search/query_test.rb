...
class SearchQueryTest < ActiveSupport::TestCase
  test '.to_h, given a search term, returns an ElasticSearch query, with
   aggregations' do
    ...
    expected_object = {"bool"=>{"must"=>{"bool"=>{"should"=>[{"nested"=>{"path"=>"designation", "query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["designation.name"], "fuzziness"=>"0"}}}}, {"nested"=>{"path"=>"iucn_category", "query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["iucn_category.name"], "fuzziness"=>"0"}}}}, {"nested"=>{"path"=>"governance", "query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["governance.name"], "fuzziness"=>"0"}}}}, {"terms"=>{"site_id"=>[]}}, {"function_score"=>{"query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["iso_3", "name", "name.stemmed", "original_name", "original_name.stemmed"], "minimum_should_match"=>"100%", "type"=>"most_fields", "fuzziness"=>"0"}}, "boost"=>"5", "functions"=>[{"filter"=>{"match"=>{"type"=>"country"}}, "weight"=>20}, {"filter"=>{"match"=>{"type"=>"region"}}, "weight"=>10}]}}, {"multi_match"=>{"query"=>"manbone", "fields"=>["label", "label.english", "label.french", "label.spanish"], "minimum_should_match"=>"0%", "type"=>"most_fields", "fuzziness"=>"0"}}, {"nested"=>{"path"=>"fragments_for_index", "query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["fragments_for_index.content", "fragments_for_index.content.english", "fragments_for_index.content.french", "fragments_for_index.content.spanish"], "fuzziness"=>"0"}}}}, {"nested"=>{"path"=>"translations_for_index.fragments_for_index", "query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["translations_for_index.fragments_for_index.content", "translations_for_index.fragments_for_index.content.english", "translations_for_index.fragments_for_index.content.french", "translations_for_index.fragments_for_index.content.spanish"], "fuzziness"=>"0"}}}}, {"nested"=>{"path"=>"categories", "query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["categories.label"], "fuzziness"=>"0"}}}}, {"nested"=>{"path"=>"topics", "query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["topics.label"], "fuzziness"=>"0"}}}}, {"nested"=>{"path"=>"ancestors", "query"=>{"multi_match"=>{"query"=>"manbone", "fields"=>["ancestors.label"], "fuzziness"=>"0"}}}}]}}}}
