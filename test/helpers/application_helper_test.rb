...
class ApplicationHelperTest < ActionView::TestCase
  ...
  test '#cover, given a pa, returns an image tag to the asset controller' do
    ...
    expected_tag = %Q{<img alt="Manbone" class="image" data-src="/assets/tiles/1?type=protected_area&amp;version=1" data-error="/images/search-placeholder-country.png" data-loading="/images/search-placeholder-country.png" src="/images/search-placeholder-country.png" />}
