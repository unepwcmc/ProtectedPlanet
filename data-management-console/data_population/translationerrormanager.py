...
class TranslationErrorManager:
    ...
    def add_unknown_attribute(self, fk_table: str, value: Any):
        self._unknown_attribute_errors.add((fk_table, value))
    ...
    def raise_any_errors(self):
        if self._key_errors or self._foreign_key_errors or self._unknown_attribute_errors or self._field_length_errors:
            raise TranslationException(self._key_errors, self._foreign_key_errors, self._unknown_attribute_errors,
                                       self.field_length_errors())
