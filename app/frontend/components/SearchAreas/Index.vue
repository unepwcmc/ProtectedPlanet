...
import type { SearchAreasProps, SearchAreasResults as SearchAreasResultsData, SearchFilterGroup } from '@/types/backend'

type SearchAreas = SearchAreasProps
const props = defineProps<SearchAreas>()
