...
INSERT INTO stg_external_recognition_cat(code, description, originator_id) VALUES('Not Reported', 'Not Reported', 10000);
...
INSERT INTO stg_community_mobility_beyond_icca_cat(code, description, originator_id) VALUES('Other:', 'Invalid', 10000);
...
INSERT into stg_habitat_types_global_cat(code, description, originator_id) VALUES('Other:','Further description needed',10000);
...
INSERT into stg_habitat_types_global_cat(code, description, originator_id) VALUES('Tropical & Subtropical Grasslands, Savannas & Shrublands','Tropical & Subtropical Grasslands, Savannas & Shrublands',10000);
...
INSERT INTO stg_resource_use_within_community_cat(code, description, originator_id) VALUES('Other - for migration','Invalid',10000);
INSERT INTO stg_resource_use_within_community_cat(code, description, originator_id) VALUES('Not Reported','Not Reported',10000);
INSERT INTO stg_resource_use_within_community_cat(code, description, originator_id) VALUES('No','No',10000);
INSERT INTO stg_resource_use_within_community_cat(code, description, originator_id) VALUES('Yes','Yes',10000);
...
INSERT INTO stg_equal_access_cat(code, description, originator_id) VALUES('Other:','Further details in equal_access_other',10000);
...
INSERT INTO stg_icca_providers_cat(code, description, originator_id) VALUES('Not Reported','Not Reported',10000);
...
INSERT INTO stg_opportunities_status_cat(code, description, originator_id) VALUES('Other:','',10000);
...
/* Install data for defined_as_protected_area_cat
INSERT INTO stg_defined_as_protected_area_cat(code, description, originator_id) VALUES('0', 'No', 10000);
INSERT INTO stg_defined_as_protected_area_cat(code, description, originator_id) VALUES('1', 'Yes', 10000);
INSERT INTO stg_defined_as_protected_area_cat(code, description, originator_id) VALUES('Not Reported', 'Not Reported', 10000);

/* Install data for defined_as_oecm_cat
INSERT INTO stg_defined_as_oecm_cat(code, description, originator_id) VALUES('0', 'No', 10000);
INSERT INTO stg_defined_as_oecm_cat(code, description, originator_id) VALUES('1', 'Yes', 10000);
INSERT INTO stg_defined_as_oecm_cat(code, description, originator_id) VALUES('Not Reported', 'Not Reported', 10000);
