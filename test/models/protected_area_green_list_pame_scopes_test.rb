...
class ProtectedAreaGreenListPameScopesTest < ActiveSupport::TestCase
  test 'pas_with_green_list_on_self_only returns PAs with green_list_status on self' do
    status = FactoryBot.create(:green_list_status)
    gl_pa = FactoryBot.create(:protected_area, green_list_status: status)
    non_gl_pa = FactoryBot.create(:protected_area, green_list_status: nil)
  ...
  test 'pas_with_green_list_on_self_or_any_parcel includes PAs with parcel-only green list' do
    status = FactoryBot.create(:green_list_status)
    pa_with_gl_parcel = FactoryBot.create(:protected_area, green_list_status: nil)
    FactoryBot.create(:protected_area_parcel, protected_area: pa_with_gl_parcel, green_list_status: status)

    pa_without_gl = FactoryBot.create(:protected_area, green_list_status: nil)
  ...
  test 'pas_with_pame_on_self_only returns PAs with PAME on self' do
    pa_with_pame = FactoryBot.create(:protected_area)
    pa_without_pame = FactoryBot.create(:protected_area)

    FactoryBot.create(:pame_evaluation, protected_area: pa_with_pame)
  ...
  test 'pas_with_pame_on_self_or_any_parcel includes PAs with parcel-only PAME' do
    ...
    FactoryBot.create(:protected_area_parcel, protected_area: pa)
    FactoryBot.create(:pame_evaluation, protected_area: nil, protected_area_parcel: pa.protected_area_parcels.first)

    other_pa = FactoryBot.create(:protected_area)
  ...
  test 'pa_or_any_its_parcels_is_greenlisted is true when PA or parcel is greenlisted' do
    status = FactoryBot.create(:green_list_status, gl_status: 'Green Listed')
    pa = FactoryBot.create(:protected_area, green_list_status: nil)
    parcel = FactoryBot.create(:protected_area_parcel, protected_area: pa, green_list_status: status)
  ...
  test 'pa_or_any_its_parcels_is_greenlist_candidate is true when any parcel is candidate' do
    status = FactoryBot.create(:green_list_status, gl_status: 'Candidate')
    pa = FactoryBot.create(:protected_area, green_list_status: nil)
    FactoryBot.create(:protected_area_parcel, protected_area: pa, green_list_status: status)
